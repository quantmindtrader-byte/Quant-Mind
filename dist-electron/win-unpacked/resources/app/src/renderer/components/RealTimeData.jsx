            ...
            <div className="space-y-2">
              {filteredLogs.map((log, index) => (
                <div
                  ...
                  className="p-2 bg-gray-900 hover:bg-gray-800 border-l-2 border-blue-500 font-mono text-xs"
                >
                  <pre className="text-base text-gray-300 whitespace-pre-wrap break-words m-0 leading-relaxed">{log.message}</pre>
                </div>
              ))}
              <div ref={logsEndRef} />
            </div>
