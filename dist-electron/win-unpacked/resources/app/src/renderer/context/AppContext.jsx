...
export function AppProvider({ children }) {
  ...
  // Not used anymore - logs come directly from terminal via IPC
  const fetchLogsFromFile = async () => {
    // Deprecated - logs now come from terminal output
  };
  ...
  useEffect(() => {
    ...
    // Clear old app start time and set new one
  ...
  const actions = {
    ...
    fetchLogsFromFile: fetchLogsFromFile,
